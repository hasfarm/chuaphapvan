    ...
    <div style="background: var(--white); padding: 2rem; border-radius: 1rem; box-shadow: var(--shadow); max-width: 600px;">
        <form method="POST" action="{{ route('admin.roles.store') }}" novalidate>
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="text" name="name" placeholder="VD: Quản Lý Chất Lượng" value="{{ old('name') }}"
                    required
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <textarea name="description" placeholder="Nhập mô tả vai trò..." rows="4"
                    style="width: 100%; padding: 0.75rem; border: 2px solid var(--light-gray); border-radius: 0.5rem; font-size: 0.95rem; font-family: inherit;">{{ old('description') }}</textarea>
            </div>
